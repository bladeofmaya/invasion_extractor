...
export default class extends ApplicationController {
  static targets = ["videoWrapper", "controls", "audioTrack", "filename", "timeline", "cutList"]
  static values = {
  ...
  reset() {
    ...
    this.videoWrapperTarget.innerHTML = '<div class="placeholder">Select a clip to preview</div>'
